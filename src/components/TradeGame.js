      ...
      <Row className="show-grid">
        <Col xs={12} md={8}>
          <div className="game-settings">
            ...
            <Companies handleSelectedCompany={props.handleSelectedCompany} fetchLiveDataForSelectedCompany={props.fetchLiveDataForSelectedCompany} turnOnLoader={props.turnOnLoader} stopPreviousGame={props.stopPreviousGame}/>
          </div>
        </Col>
